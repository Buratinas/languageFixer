[{assign var="template_title" value="REVIEW"|oxmultilangassign }]
...
[{capture append="oxidBlock_content"}]
    ...
    [{if $oView->getProduct()}]
        ...
        <div class="lineView clear">
            ...
            <div class="pictureBox">
                ...
                <a href="[{$_productLink}]" class="viewAllHover glowShadow corners" title="[{ $product->oxarticles__oxtitle->value}]"><span>[{oxmultilang ident="DETAILS"}]</span></a>
    ...
    <div class="widgetBox reviews">
        <h4>[{oxmultilang ident="WRITE_REVIEW"}]</h4>
